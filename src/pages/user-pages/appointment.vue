<template>
  <div class="flex flex-col sm:flex-row min-h-screen bg-gray-100 text-gray-800 overflow-hidden">
    <!-- ░░ Sidebar ░░ -->
    <div
      class="w-full sm:w-64 sm:h-screen sticky top-0 border-b sm:border-b-0 sm:border-r border-gray-200 bg-white z-20"
    >
      <Sidebar />
    </div>
    ...
    <div v-if="showServiceModal" class="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div
        class="relative bg-white max-w-2xl w-full mx-4 rounded-xl shadow-lg border border-gray-200 p-4 sm:p-6 z-10 space-y-4"
      >
    ...
    <!-- Success & Error Modals (unchanged) -->
    <!-- ... -->
    <!-- (they remain exactly as you already have in your code) -->
  </div>
</template>
...
/* for success/error modal transitions */
.fade-enter-active,
.fade-leave-active {
